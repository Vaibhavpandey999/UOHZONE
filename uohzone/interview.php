...
if((isset($_SESSION['loggedin'])) && $_SESSION['loggedin']==true){ }
      ...
      <strong>   Alert!</strong>    You Are Not Logged In Please Login To Add An Interview Experience !
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $candidatename= mysqli_real_escape_string($conn,$_POST["candidate"]);


  $candidatename=str_replace("<","&lt;",$candidatename);
  $candidatename=str_replace(">","&gt;",$candidatename);
  
  $candidatename=str_replace("'","&apos",$candidatename);
  
  $candidatename=str_replace(`"`,"&quot",$candidatename);
  ...
  $uoh_no= mysqli_real_escape_string($conn,$_POST["registration"]);




  $uoh_no=str_replace("<","&lt;",$uoh_no);
  $uoh_no=str_replace(">","&gt;",$uoh_no);
  
  $uoh_no=str_replace("'","&apos",$uoh_no);
  
  $uoh_no=str_replace(`"`,"&quot",$uoh_no);
...
$course=str_replace("'","&apos",$course);

$course=str_replace(`"`,"&quot",$course);
...
$company=str_replace("'","&apos",$company);

$company=str_replace(`"`,"&quot",$company);
...
$job_profile=str_replace("<","&lt;",$job_profile);
$job_profile=str_replace(">","&gt;",$job_profile);

$job_profile=str_replace("'","&apos",$job_profile);

$job_profile=str_replace(`"`,"&quot",$job_profile);
...
$interview_exp= mysqli_real_escape_string($conn,$_POST["interview"]);
...
$interview=str_replace("'","&apos",$interview);

$interview=str_replace(`"`,"&quot",$interview);
