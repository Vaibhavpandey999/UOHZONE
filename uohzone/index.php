...
<div id="carouselExampleCaptions" class="aa carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/bb.jpeg" class="aaa d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h2 class="text-dark">Buy Or Sell 2nd hand Books</h2>
        <h4 class="text-dark">U can Buy Or Post an add To Sell 2nd Hand Books With In The University Campus  .</h4>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h2 class="text-dark">Interview Experiances</h2>
        <h4 class="text-dark"><strong>U Can View Or Add Interview Experiances Of The Companies.</strong></h4>
        <a href="interview.php" target="_self" class="text-light btn btn-primary btn-outline-success  btn-lg  mx-auto">Proceed</a>

      </div>
    </div>
    <div class="carousel-item">
      <img src="images/not.jpeg" class="aaa d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h2 class="text-dark">Download Or Upload Notes/Free E-Books</h2>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h2 class="text-dark">Placement Stuffs</h2>
        <h4 class="text-dark"><strong>Collection Of All Resources You Need For Placement Preapration.</strong></h4>
  ...
  <button class="text-dark carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
    ...
    <span class="text-dark"><b>Previous</b></span>
  </button>
  <button class="text-dark carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
    ...
    <span class=" text-dark"><b>Next</b></span>
  </button>
</div>
...
<section class="text-center container" id="about">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              ...
              <li>  <h5><strong>A place where you can sell your 2nd hand books to other students with in University Of Hyderabad Campus.</strong></h5></li>
                       <li><h5><strong>Write your Interview Experiances .</strong></h5></li>
                       <li><h5><strong>Upload Or Download Notes Or Free E-Books via Drive Links(U have to upload materials in your drive or cloud storage then provide the link and make it public.).</strong></h5></li>
                         <li><h5><strong>Free Resources of Placement Materials.</strong></h5></li>
