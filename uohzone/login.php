...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    $sql = "Select * from uohstudent where uohmail='$email' ";
...
<!-- --Login-- Modal -->
<div   id="login"   class="modal fade  "  tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
