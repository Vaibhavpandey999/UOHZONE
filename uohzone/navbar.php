  ...
  <nav style="background-color:#000000 " class="navbar ttt navbar-expand-lg navbar- bg-">
        ...
        <img src="images/logo11.png" width="80px" height="70px" style="background-color:gray" >
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            echo '<button  class=" text-dark nav-link btn btn-light btn-outline-warning mx-2 " data-toggle="modal" data-target="#login">Login</button>
            <button style="background color:black" class="text-dark nav-link btn btn-light btn-outline-warning " data-toggle="modal" data-target="#signup"  >
    Signup</button>';
            }
          if($loggedin){
