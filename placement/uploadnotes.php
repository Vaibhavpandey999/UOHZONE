...
echo '<div id="upload"  class="modal fade  "  tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div   class=" modal-dialog modal-dialog-scrollable" role="document" >
    <div class="modal-content border border-dark"  style="background-color: #FFB6C1 ;" width="800px">
     ...
     <input type="text" name="subject" class="f1 t1 form-control" placeholder="Subject" value="" required="">
   </div>
   <div class="form-group">
     <label class="text-dark"  for="post_title">Notes/Ebook Description</label>
     <input type="text" name="description" class=" f1 form-control" placeholder="Description" required="">
   </div>
   <div class="form-group">
     <label class="text-dark" for="post_title">Name OF the Notes/Ebook </label>
     <input type="text" name="notes_name" class=" f1 form-control" placeholder="Name" value="" required="">
   </div>


   <div class="form-group">
     <label   class="text-dark" for="post_title">Uploaded by</label>
     <input type="text" name="uploader" class="f1 form-control" placeholder="Your Reg No" value="" required="">
   </div>
   <div class="form-group">
     <label  class="text-dark" for="post_tags">Author</label>
     <input type="text" name="author" class="f1 form-control" placeholder="Author" value="" required="">
   </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $book_name = $_POST['notes_name'];
  $down_link = $_POST['link'];
  $author = $_POST['author'];
